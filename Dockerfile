...
ENV LINUX=/workdir/rpi64-linux \
    ...
    RPI_KERNEL_BRANCH=rpi-4.20.y \
    TIMESTAMP_OUTPUT=true

# Install build dependencies
RUN apt-get update && \
apt-get install -y libssl-dev flex bison bc build-essential curl git-core libncurses5-dev module-init-tools
...
# Get the Linux kernel 4.20 source
